...
@ManagedBean(name = "agendaControle")
@SessionScoped
...
//        objeto = new Chamado();
//        String jpql = "from Chamado";
//	lista = em.createQuery(jpql).getResultList();
//        for (int i=0; i<lista.size(); i++){
//        objeto = lista.get(i);
//            
//        eventModel.addEvent(new DefaultScheduleEvent(objeto.getFuncionario().toString()
//                , objeto.getDataMarcada(), objeto.getDataMarcada())); 
//        
//        eventModel = new DefaultScheduleModel();
//        }
//        eventModel.addEvent(new DefaultScheduleEvent("Teste",previousDay8Pm(),previousDay8Pm()));
