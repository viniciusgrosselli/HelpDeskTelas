...
public class EmailUtils {
    ...
    private static final String USERNAME = "helpdeskprojetotcc";
    private static final String PASSWORD = "96159944";
    private static final String EMAILORIGEM = "helpdeskprojetotcc@gmail.com";
